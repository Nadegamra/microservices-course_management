...
namespace CourseManagement.Logic.Endpoints.Skills.RemoveSkill
{
    public class DeleteSkillEndpoint: EndpointExtended<DeleteSkillRequest>
    {
        public override void Configure()
        {
            ConfigureEndpoint("deleteSkill");
        }
